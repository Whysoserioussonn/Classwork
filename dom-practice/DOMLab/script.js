...
// Task 2.0 Select and cache the <nav id="top-menu">element in a variable
// named topMenuEl.
...
// Task 2.2 Set the background color of topMenuEl to the value stored in
...
// Task 3.1a  Iterate over the entire menuLinksarray and for each "link" object:
...
// Task 4.0 Select and cache the <nav id="sub-menu">element in a variable
// named subMenuEl.
...
// Task 4.2 Set the background color of subMenuElto the value stored in 
...
// Task 5.0  Update the menuLinksarray in script.js . UPDATE AT TOP OF FILE
...
let showingSubMenu = false;
 ...
 4. console.logthe content of the <a> to verify the handler is working.
 */
...
/* Task 5.7 
  ...
  */
  if (showingSubMenu) {
   ...
   //Pregress check , take the menu for a test drive.  Sub menu should appear
